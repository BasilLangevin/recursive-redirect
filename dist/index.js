...
exports.RedirectLoopError = void 0;
 ...
 */
function containsMatchGroup(path) {
...
class RedirectRule {
     ...
     */
    processSimple(path) {
        if (trimTrailingSlash(path) !== trimTrailingSlash(this.from))
            return path;
 ...
 */
function getRedirect(url, redirects) {
